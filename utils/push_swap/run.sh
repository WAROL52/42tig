...
function run() {
	...
	if [ $? -gt 0 ]; then
		...
		vrun ./push_swap $tmpVClient '28 48 22 6 30 19 4 17 1 26 16 12 44 45 23 11 14 10 24 38 31 20 42 37 40 36 39 9 46 35 29 41 25 8 13 3 33 7 47 27 43 49 5 21 15 34 32 50 2 18 '
